        ...
        <form-wizard @on-complete="store" finishButtonText="Save" :validateOnBack="true" ref="formWizard">
            ...
            <TabContent title="Main details" icon="fa fa-user"  :before-change="validateMainDetails">
                <div class="d-flex flex-column mb-2">
                    ...
                    <div class="col-4 mx-auto" v-if="isEditState">
                        <input class="form-control" :disabled="!isEditState" :class="{ 'is-invalid': v$.file.$dirty && (v$.file.required.$invalid) }" type="file" id="formFile" @change="uploadImage" accept="image/png, image/jpeg">
                        <div  v-if="v$.file.$dirty && isEditState" :class="{ 'invalid-feedback':(v$.file.required.$invalid )}">
                ...
                <div class="row">
                    <div class="col-6">
                        ...
                        <input required type="name" :disabled="!isEditState" @click="clearFormErrors" :class="{ 'is-invalid': v$.name.$dirty && (v$.name.required.$invalid) }" class="form-control" v-model="name" autocomplete="name" >
                    ...
                    <div class="col-6">
                        ...
                        <textarea  class="form-control" rows="5" name="exampleInputPassword" :disabled="!isEditState" v-model="description" required></textarea>
                    </div>
                </div>
            </TabContent>
            <TabContent title="Location" icon="fa fa-location-dot" :before-change="validateLocationInformation">
                <div class="row">
                    <div class="col-12">
                        ...
                        <textarea  class="form-control" rows="3" :disabled="!isEditState"  :class="{ 'is-invalid': v$.address.$dirty && (v$.address.required.$invalid || v$.address.maxLength.$invalid ) }" name="exampleInputPassword"  v-model="address" required></textarea> 
                ...
                <div class="row">
                    <div class="col-6">
                        ...
                        <input type="text" v-model="city" :disabled="!isEditState" class="form-control" :class="{ 'is-invalid': v$.city.$dirty && (v$.city.required.$invalid) }"  id="formcity">
                    ...
                    <div class="col-6">
                        ...
                        <input type="text" class="form-control" :disabled="!isEditState" v-model="state" autocomplete="state" required>
                    </div>
                </div>
                <div class="row">
                    <div class="col-6">
                        <label for="exampleInputPassword1" class="form-label">Country <code>*</code></label>
                        <input type="text" v-model="country"  :disabled="!isEditState" class="form-control" :class="{ 'is-invalid': v$.country.$dirty && (v$.country.required.$invalid) }" id="formcountry">
                    ...
                    <div class="col-6">
                        ...
                        <input type="text" v-model="zip_code"  :disabled="!isEditState" class="form-control" :class="{ 'is-invalid': v$.zip_code.$dirty && (v$.zip_code.required.$invalid || v$.zip_code.minLength.$invalid || v$.zip_code.maxLength.$invalid  ) }"  id="formzip_code">
                ...
                <div class="row">
                    <div class="col-6">
                        ...
                        <input type="text" class="form-control" :disabled="!isEditState" v-model="latitude" autocomplete="country" required>
                    </div>
                    <div class="col-6">
                        <label for="exampleInputPassword1" class="form-label">Longitude</label>
                        <input type="text" class="form-control" :disabled="!isEditState" v-model="longitude" autocomplete="zip_code" required>
                    </div>
                </div>
            </TabContent>
            ...
            <TabContent title="Others" icon="fa fa-layer-group">
                <div class="row">
                    <div class="col-6">
                        ...
                        <input type="text" :disabled="!isEditState" v-model="other_details.facebook" class="form-control"  id="formcity">
                    </div>
                    <div class="col-6">
                        <label for="exampleInputPassword1" class="form-label">Twitter</label>
                        <input type="text" :disabled="!isEditState" class="form-control" v-model="other_details.twitter" autocomplete="state" required>
                    </div>
                </div>
                <div class="row">
                    <div class="col-6">
                        <label for="exampleInputPassword1" class="form-label">Instagram</label>
                        <input type="text" :disabled="!isEditState" v-model="other_details.instagram" class="form-control"  id="formcity">
                    </div>
                    <div class="col-6">
                        <label for="exampleInputPassword1" class="form-label">Tiktok</label>
                        <input type="text" :disabled="!isEditState" class="form-control" v-model="other_details.tiktok" autocomplete="state" required>
                    </div>
                </div>
                <div class="row">
                    <div class="col-12">
                        <label for="exampleInputPassword1" class="form-label">Shipping Policy</label>
                        <textarea  class="form-control" :disabled="!isEditState" rows="5" name="exampleInputPassword" v-model="other_details.shipping_policy" required></textarea>
                    </div>
                </div>
                <div class="row">
                    <div class="col-12">
                        <label for="exampleInputPassword1" class="form-label">Return Policy</label>
                        <textarea  class="form-control" :disabled="!isEditState" rows="5" name="exampleInputPassword" v-model="other_details.returns_policy" required></textarea>
                    </div>
                </div>
            </TabContent>
        </form-wizard>
        ...
        computed:{
            changeFormState(){
                    ...
                    for (var i = 0; i < codeElements.length; i++) {
                        codeElements[i].classList.add('d-none');
                    }
            }
        },
        components: {
