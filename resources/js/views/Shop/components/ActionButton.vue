...
<script>
    export default {
        methods: {
            visitShop() {
                this.params.context.componentParent.visitShop(this.params.data)
            },
            editShop() {
                this.params.context.componentParent.editShop(this.params.data)
            },
            deleteShop() {
                this.params.context.componentParent.deleteConfirmation(this.params.data)
            },
        },
    }
</script>
